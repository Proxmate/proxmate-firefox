(function () {
    ...
    EventBinder = (function () {
        ...
        EventBinder.prototype.handlePort = function (port) {
            ...
            port.on('dailyChannelCheck', function(payload){
                Status.dailyChannelCheck();
                return port.emit(payload.eventId, {});
            });
            port.on('dailyActiveCheck', function(payload){
            ...
            port.on("selectNetflix", function (payload) {
                console.info(payload)
                PackageManager.selectNetflixCountry({short_hand: payload.country}, function (response) {
